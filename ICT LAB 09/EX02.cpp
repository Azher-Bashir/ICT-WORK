...
//    int year;
//public:
//    publisher(string name, int year) : name(name), year(year) {}
...
//    int books;
//public:
//    author(string name, string country, int books = 0) : name(name), country(country), books(books) {}
//    string getcountry() {
//        return country;
//    }
//    string getname() {
...
//    author auth;
//public:
//    book(string title, double price, publisher pub, author auth) : title(title), price(price), pub(pub), auth(auth) {} // Fix: use the correct parameters
