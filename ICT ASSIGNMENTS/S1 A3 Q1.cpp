...
//	cout << "Radius of the circle is: " << setprecision(2) << fixed << rad << endl;
//	return rad;
//}
//
...
//{
//	cir = 2 * pi * rad;
//	cout << "circumference of the circle is: " << setprecision(2) << fixed << cir << endl;
//	return cir;
//}
//
...
//	cout << "Surface area of the circle is: " << setprecision(2) << fixed << surf_area << endl;
//	return surf_area;
//}
//
...
//	cout << "Volume of cylinder is: " << setprecision(2) << fixed << vol << endl;
//	return vol;
//}
//
//
